...
SECRET_KEY = '8kwDnEP-0S53TCsQ37K1DVzumjqIPqcII5Jyn7Y9f1g='

# SECURITY WARNING: don't run with debug turned on in production!
DEBUG = True

ALLOWED_HOSTS = ['localhost', '127.0.0.1', '10.2.74.222', '*']
...
TEMPLATES = [
    {
        ...
        'OPTIONS': {
            'context_processors': [
                ...
                'GC2.context_processors.current_page_name',
            ],
        },
    },
]
...
EMAIL_HOST = 'premium227.web-hosting.com'
EMAIL_PORT = 465
EMAIL_USE_SSL = True
EMAIL_HOST_USER = 'gestsqgv@gestionconocimientosena.org'
EMAIL_HOST_PASSWORD = 'o@hLm*cQ{.*O'
DEFAULT_FROM_EMAIL = f'InnHub <{EMAIL_HOST_USER}>'
